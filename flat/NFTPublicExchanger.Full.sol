...
// File contracts/INFTPrivateSeller.sol
...
// File contracts/NFTPublicExchanger.sol

pragma solidity =0.6.2;
/**
 * @title NFTPublicExchanger - Special exchange contract
 * where NFT will be replaced by native ERC20 token.
 *
 * @author Pavel Bolhar <paul.bolhar@gmail.com>
 */
contract NFTPublicExchanger is IERC721Receiver, Ownable {
    using SafeMath for uint256;
